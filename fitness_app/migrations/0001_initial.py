# Generated by Django 5.2.8 on 2025-12-28 01:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('visualization_video_path', models.CharField(blank=True, max_length=500)),
                ('predictions_csv_path', models.CharField(blank=True, max_length=500)),
                ('total_repetitions', models.IntegerField(default=0)),
                ('correct_form_count', models.IntegerField(default=0)),
                ('predictions_data', models.JSONField(blank=True, default=dict)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('video', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='analysis', to='fitness_app.pushupvideosmodel')),
            ],
        ),
    ]
